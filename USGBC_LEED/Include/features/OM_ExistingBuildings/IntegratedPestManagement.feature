...
Feature: Entering data to Integrated Pest Management form - LEED v4.1 O+M: EB
  ...
  Scenario Outline: Filling Integrated Pest Management form for In-house IPM program
    ...
    Examples: 
      ...
      | Integrated Pest Management-InHouseIPM | BDD6 TestProject | O+M:EB       |
  ...
  Scenario Outline: Filling Integrated Pest Management form for Certified IPM service
    ...
    Examples: 
      | formname                                       | project          | ratingSystem |
      | Integrated Pest Management-CertifiedIPMService | BDD6 TestProject | O+M:EB       |

  @RegressionTest
  Scenario Outline: Checking Auto Save functionality  in Integrated Pest Management form for In-house IPM program
    Given User clicks on project <project>
    And User navigates to the credits page of the project
    And User should be on form <formname> rating <ratingSystem>
  ...
  @RegressionTest
  Scenario Outline: Checking Auto Save functionality  in Integrated Pest Management form for Certified IPM service
    Given User clicks on project <project>
    And User navigates to the credits page of the project
    And User should be on form <formname> rating <ratingSystem>
    And User will select the Radio Button
